  ...
  passwordHash: 'Axion2026!', // simple secure comparison for dashboard
    ...
    conversations: [
      {
        ...
        handoffReason: 'Inquiring about multi-depot WMS with SAP Business One real-time sync.',
        createdAt: new Date(Date.now() - 3600000 * 2).toISOString(),
        updatedAt: new Date(Date.now() - 1800000).toISOString(),
        unreadAdminCount: 1,
        unreadVisitorCount: 0,
        lastMessage: 'Can someone from the technical team advise if Axion WMS supports offline barcoding in warehouses with intermittent internet?',
      },
      {
        id: 'conv-sample-2',
        visitorId: 'vis-102',
        ...
        unreadAdminCount: 0,
        unreadVisitorCount: 0,
        lastMessage: 'Axion AI intelligent agent architecture handles bilingual Arabic/English document parsing seamlessly.',
      },
    ],
    messages: [
      {
        ...
        content: 'Hello, we operate 4 distribution warehouses across Lagos, Kano, and Abuja. Does Axion WMS support batch tracking and SAP Business One integration?',
        createdAt: new Date(Date.now() - 3600000 * 2).toISOString(),
      },
      {
        id: 'msg-2',
        ...
        senderRole: 'ai',
        senderName: 'Axion AI',
        content: 'Yes! Axion WMS features native two-way synchronization with SAP Business One, automated batch/lot tracking, barcode scanner support, and real-time inventory visibility across distributed multi-warehouse sites.',
      ...
      },
      {
        ...
        senderRole: 'visitor',
        senderName: 'Engr. Farouk Al-Hassan',
        content: 'Can someone from the technical team advise if Axion WMS supports offline barcoding in warehouses with intermittent internet? I want to speak with someone.',
      ...
      },
      {
        ...
        senderRole: 'system',
        senderName: 'System',
        content: 'Human specialist requested. An Axion enterprise engineer has been alerted and will join shortly.',
    ...
    leads: [
      {
        ...
        status: 'QUALIFIED',
        priority: 'HIGH',
        notes: 'High priority lead. Requires 4-site deployment assessment and offline handheld support.',
      ...
      },
      {
        ...
        status: 'PROPOSAL',
        priority: 'HIGH',
        notes: 'Proposal sent for SAP Business One cloud migration and shop-floor automation.',
    ...
    contactMessages: [
      {
        ...
        message: 'We are seeking an intelligent OCR and workflow automation pipeline to parse medical billing claims from PDF forms into our core ERP.',
        status: 'CONVERTED',
        leadId: 'lead-2',
        createdAt: new Date(Date.now() - 86400000 * 2).toISOString(),
        updatedAt: new Date(Date.now() - 86400000).toISOString(),
      },
      {
        ...
        message: 'Looking for a multi-temperature cold storage warehouse management system with IoT sensor integration and automated dispatch routing.',
        status: 'NEW',
      ...
      },
      {
        ...
        message: 'We want to modernize our agricultural aggregation, weighing scale integrations, and export compliance reporting.',
        status: 'CONTACTED',
    ...
    knowledgeBase: [
      ...
      },
      {
        ...
        category: 'Products',
        content: 'Axion AI (Status: Available) is an enterprise autonomous intelligence suite comprising domain-specific AI agents, multilingual conversational assistants, deep OCR document parsers, and automated decision engines that integrate directly into enterprise ERP and CRM systems.',
        keywords: ['axion ai', 'agents', 'assistants', 'ocr', 'document intelligence', 'available'],
        isPublished: true,
        priority: 90,
        updatedAt: now,
      },
      {
        ...
        category: 'Products',
        content: 'Axion Vault (Status: In Development) is an enterprise knowledge repository and intelligent document compliance engine combining project workflows, encrypted documentation, semantic enterprise search, and automated audit trails.',
        keywords: ['axion vault', 'documents', 'knowledge', 'in development', 'compliance'],
        isPublished: true,
        priority: 85,
        updatedAt: now,
      },
      ...
      },
      {
        ...
        category: 'Industries',
        content: 'Axion provides tailored digital architectures across Manufacturing, Logistics & Supply Chain, Warehousing & Distribution, Retail, Healthcare, Education, Financial Services, Construction, Agriculture, Professional Services, SMEs, and Large Enterprises in Nigeria, GCC/Saudi Arabia, and globally.',
        keywords: ['industries', 'manufacturing', 'logistics', 'healthcare', 'retail', 'agriculture', 'sme', 'enterprise'],
        isPublished: true,
        priority: 80,
        updatedAt: now,
      },
      ...
      },
      {
        ...
        category: 'Contact',
        content: 'Offices: Lagos (Victoria Island, Lagos, Nigeria), Riyadh (King Fahd Road, Riyadh, Saudi Arabia), London (Support & Engineering Node). Direct email: contact@axiontech.com or abdullahiabubakar9992@gmail.com. Phone: +234 1 800 AXION / +966 11 800 AXION. You can submit inquiries 24/7 on our contact form or request a live specialist via this chat.',
        keywords: ['contact', 'email', 'phone', 'location', 'office', 'lagos', 'riyadh'],
        isPublished: true,
        priority: 85,
        updatedAt: now,
      },
    ...
    products: [
      {
        ...
        description: 'Enterprise AI suite featuring multi-agent workflow orchestration, multilingual Arabic/English document intelligence, intelligent OCR, and enterprise ERP connectors.',
        status: 'Available',
        features: [
        ...
        targetIndustries: ['Financial Services', 'Healthcare', 'Logistics', 'Enterprise Organizations'],
        specs: ['Latency: <350ms', 'Accuracy: 99.4% on structured forms', 'Deployment: Cloud / On-Premise / Hybrid'],
        icon: 'Bot',
      },
      {
        id: 'prod-2',
        ...
        description: 'Enterprise document intelligence and knowledge management system designed for regulatory compliance, contract analysis, and unified project repositories.',
        ...
        targetIndustries: ['Construction', 'Professional Services', 'Healthcare', 'Financial Services'],
        specs: ['SOC2 & ISO 27001 Ready Architecture', 'Supports 100+ Document Types', 'Vectorized Knowledge Index'],
        icon: 'FolderLock',
      },
      {
        id: 'prod-3',
        ...
        description: 'High-velocity Warehouse Management System engineered for rugged industrial operations, handheld barcode/RFID scanning, automated batch tracking, and direct SAP sync.',
        status: 'Available',
        features: [
        ...
        specs: ['Sub-second barcode scan resolution', 'Full offline sync queue', 'IoT scale & cold-chain sensor compatible'],
        icon: 'Warehouse',
      },
    ],
    services: [
      {
        ...
        shortDesc: 'Autonomous AI agents, document intelligence, OCR, and automated end-to-end business workflows.',
        fullDesc: 'We build practical AI systems tailored to real business operations. From intelligent OCR document processing to autonomous enterprise agents that monitor systems, route approvals, and resolve complex multi-step workflows.',
        capabilities: [
      ...
      },
      {
        ...
        shortDesc: 'Certified SAP Business One implementations, legacy integrations, custom add-ons, and data pipelines.',
        fullDesc: 'We bridge enterprise ERP systems with modern front-end applications, mobile tools, and automated pipelines. Whether deploying SAP Business One from scratch or building custom API middleware.',
        capabilities: [
      ...
      },
      {
        ...
        shortDesc: 'Bespoke customer portals, internal operational systems, and resilient cloud architectures.',
        fullDesc: 'We build high-performance custom business software that eliminates spreadsheets and fragmented tools. Designed for resilience, security, and high transactional throughput.',
        capabilities: [
      ...
      },
      {
        ...
        shortDesc: 'High-throughput inventory tracking, multi-depot logistics, barcode/RFID, and fleet visibility.',
        fullDesc: 'Transform warehouse floors from chaotic paper-based tracking into precision digital command centers. Our WMS solutions deliver sub-second inventory visibility, barcode integration, and intelligent picking paths.',
        capabilities: [
      ...
      },
      {
        ...
        shortDesc: 'Real-time executive dashboards, data warehousing, KPI monitors, and operational reporting.',
        fullDesc: 'Turn dark enterprise data into actionable executive intelligence. We build automated data pipelines, central data marts, and real-time visualization dashboards.',
        capabilities: [
      ...
      },
      {
        ...
        shortDesc: 'Strategic technology audits, legacy system modernization, and scalable engineering roadmaps.',
        fullDesc: 'We help enterprise leadership navigate complex technical evolutions without disrupting day-to-day operations. From legacy decoupling to cloud migration and change management.',
        capabilities: [
    ...
    industries: [
      {
        ...
        tagline: 'Shop-floor visibility, ERP material tracking, and automated quality logging.',
        challenges: ['Fragmented production data', 'Unplanned machine downtime', 'Manual scrap tracking'],
        solutionsApplied: ['Axion AI quality inspection OCR', 'SAP B1 production routing', 'IoT sensor telemetry'],
        caseExample: 'Automated shop-floor data collection across 6 assembly lines for a heavy machinery producer.',
      ...
      },
      {
        ...
        challenges: ['Delayed bills of lading processing', 'Port congestion blindspots', 'Manual manifest creation'],
        solutionsApplied: ['Bilingual OCR for airway bills & manifests', 'Real-time fleet API gateways', 'Axion WMS cross-docking'],
      ...
      },
      {
        ...
        challenges: ['Mispick errors', 'Ghost stock in large warehouses', 'Slow order fulfillment turnaround'],
        solutionsApplied: ['Axion WMS deployment', 'Handheld terminal integration', 'Automated pick routes'],
      ...
      },
      {
        ...
        slug: 'retail-fmcg',
        name: 'Retail & FMCG',
        tagline: 'Omnichannel stock visibility, POS to ERP integration, and demand forecasting.',
        challenges: ['Stockouts on fast-moving items', 'Slow price updates across branch networks', 'Manual vendor orders'],
        solutionsApplied: ['Real-time POS sync to SAP', 'Automated purchase order generators', 'Supplier portal'],
      ...
      },
      {
        ...
        challenges: ['Slow insurance claim approvals', 'Stringent cold-chain drug compliance', 'Siloed hospital records'],
        solutionsApplied: ['Axion OCR for claim forms', 'WMS temperature audit logging', 'HIPAA/local compliant portals'],
    ...
    notifications: [
      {
        ...
        message: 'Engr. Farouk Al-Hassan requested human assistance regarding Axion WMS & SAP B1 integration.',
      ...
      },
      {
        ...
        message: 'Mustafa Al-Zahrani submitted an inquiry for Cold Storage WMS solutions.',
        link: '/admin/messages',
        read: false,
        createdAt: new Date(Date.now() - 3600000 * 4).toISOString(),
      },
      {
        ...
        message: 'Khalid Al-Ghamdi (Red Sea Petrochemical) requested an ERP proposal ($78,000 USD).',
        link: '/admin/leads',
        read: true,
        createdAt: new Date(Date.now() - 86400000 * 4).toISOString(),
      },
    ...
    analyticsEvents: [
      { id: 'ev-1', eventType: 'page_view', page: '/', visitorId: 'vis-101', timestamp: new Date(Date.now() - 3600000 * 3).toISOString() },
      { id: 'ev-2', eventType: 'page_view', page: '/solutions', visitorId: 'vis-101', timestamp: new Date(Date.now() - 3600000 * 2.5).toISOString() },
      { id: 'ev-3', eventType: 'chat_open', page: '/solutions/wms', visitorId: 'vis-101', timestamp: new Date(Date.now() - 3600000 * 2).toISOString() },
      { id: 'ev-4', eventType: 'human_handoff_trigger', page: '/solutions/wms', visitorId: 'vis-101', timestamp: new Date(Date.now() - 1800000).toISOString() },
      { id: 'ev-5', eventType: 'page_view', page: '/products', visitorId: 'vis-102', timestamp: new Date(Date.now() - 3600000 * 5).toISOString() },
    ],
    settings: {
      ...
      offices: [
        { city: 'Lagos', country: 'Nigeria', address: 'Plot 14B, Victoria Island Tech Hub', phone: '+234 1 800 29466' },
        { city: 'Riyadh', country: 'Saudi Arabia', address: 'King Fahd Road, Al-Olaya Business Tower', phone: '+966 11 800 2946' },
        { city: 'London', country: 'United Kingdom', address: '124 City Road, Tech City Hub', phone: '+44 20 7946 0991' },
      ],
...
class Database {
  ...
  getAdminByUsername(username: string) {
    return this.data.admins.find((a) => a.username.toLowerCase() === username.toLowerCase() || a.email.toLowerCase() === username.toLowerCase());
  }
  ...
  getConversations(): Conversation[] {
    return [...this.data.conversations].sort((a, b) => new Date(b.updatedAt).getTime() - new Date(a.updatedAt).getTime());
  }
  ...
  getConversationByVisitor(visitorId: string): Conversation | undefined {
    return this.data.conversations.find((c) => c.visitorId === visitorId && c.status !== 'CLOSED');
  }

  createConversation(conv: Omit<Conversation, 'id' | 'createdAt' | 'updatedAt' | 'unreadAdminCount' | 'unreadVisitorCount'>): Conversation {
    const now = new Date().toISOString();
  ...
  createContactMessage(msg: Omit<ContactMessage, 'id' | 'createdAt' | 'updatedAt'>): ContactMessage {
    const now = new Date().toISOString();
  ...
  createKnowledgeEntry(entry: Omit<KnowledgeEntry, 'id' | 'updatedAt'>): KnowledgeEntry {
  ...
  updateKnowledgeEntry(id: string, updates: Partial<KnowledgeEntry>): KnowledgeEntry | undefined {
  ...
  deleteKnowledgeEntry(id: string): boolean {
    ...
    this.data.knowledgeBase = this.data.knowledgeBase.filter((k) => k.id !== id);
  ...
  updateProduct(id: string, updates: Partial<ProductItem>): ProductItem | undefined {
  ...
  createNotification(notif: Omit<AdminNotification, 'id' | 'createdAt' | 'read'>): AdminNotification {
  ...
  // Analytics Events
  logAnalyticsEvent(eventType: string, page: string, visitorId: string, metadata?: any) {
  ...
  getAnalyticsSummary(): any {
    ...
    const activeChats = this.data.conversations.filter((c) => c.status === 'HUMAN_ACTIVE' || c.status === 'HUMAN_REQUESTED').length;
    const humanRequests = this.data.conversations.filter((c) => c.status === 'HUMAN_REQUESTED' || c.status === 'HUMAN_ACTIVE').length;
    const aiConversations = this.data.conversations.filter((c) => c.status === 'AI_ACTIVE').length;
    const newLeads = this.data.leads.length;
    const contactMessages = this.data.contactMessages.length;

    // Unique visitors
    const uniqueVisitors = new Set(this.data.analyticsEvents.map((e) => e.visitorId));
    const totalVisitors = Math.max(uniqueVisitors.size, totalConversations * 2 + 15);
    ...
    const topQuestions = [
      ...
      { question: 'Does Axion WMS integrate with SAP Business One?', count: 14 },
      { question: 'Can you build custom AI agents for our ERP?', count: 11 },
      { question: 'What are your office locations in Nigeria and Saudi Arabia?', count: 8 },
    ...
    const funnelData = [
      ...
      { stage: 'AI Chat Engagements', count: totalConversations, percentage: Math.min(100, Math.round((totalConversations / Math.max(1, totalVisitors)) * 100)) },
      { stage: 'Human Consultations', count: humanRequests, percentage: Math.min(100, Math.round((humanRequests / Math.max(1, totalVisitors)) * 100)) },
      { stage: 'Captured Leads & Forms', count: newLeads + contactMessages, percentage: Math.min(100, Math.round(((newLeads + contactMessages) / Math.max(1, totalVisitors)) * 100)) },
      { stage: 'Qualified Proposals', count: this.data.leads.filter((l) => l.status === 'PROPOSAL' || l.status === 'WON').length, percentage: Math.min(100, Math.round((this.data.leads.filter((l) => l.status === 'PROPOSAL' || l.status === 'WON').length / Math.max(1, totalVisitors)) * 100)) },
    ];
